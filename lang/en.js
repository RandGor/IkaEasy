export default {
    ...
    "char_month": "M",
    "char_year": "y",
    "option.academy_payback": "Show Academy upgrade payback chart",
    "academy_payback.title": "Academy upgrade payback",
    "academy_payback.upgrade": "Upgrade",
    "academy_payback.rate": "Research points per scientist / hour",
    "academy_payback.exchange_rate": "Research points per crystal",
    "academy_payback.rate_hint": "Starting rates use known research, government, corruption and Optician bonuses. Adjust them for extra world or temporary bonuses.",
    "academy_payback.crystal": "Crystal for the upgrade",
    "academy_payback.scientists": "Additional scientists",
    "academy_payback.payback": "Crystal payback",
    "academy_payback.after_building": "After construction finishes",
    "academy_payback.research_line": "Additional scientists",
    "academy_payback.exchange_line": "Crystal exchanged for research",
    "academy_payback.chart": "Additional research compared with exchanging the upgrade's crystal cost",
    "academy_payback.assumptions": "Only the new scientist places count, fully staffed around the clock. Excludes wood, gold upkeep and construction time. Crystal is valued at the exchange rate above.",
    "academy_payback.error_capacity": "No verified scientist capacity is available for this upgrade.",
    "academy_payback.error_price": "No verified crystal price is available for this upgrade.",
    "academy_payback.error_rate": "Enter a non-negative scientist output and an exchange rate greater than zero.",
    "academy_payback.never": "No payback",
    "academy_payback.years_short": "y",
    "academy_payback.days_short": "d",
    "academy_payback.live_price": "Current price from the game",
    "academy_payback.table_price": "Saved price, city discounts applied",
    "academy_payback.points_daily": "research points / day",
    "academy_payback.experiment_time": "300,000 points from the additional scientists:",
    "academy_payback.points": "Research points",
    "academy_payback.axis_years": "Years after construction",
    "academy_payback.axis_days": "Days after construction",
    ...
    "support_text": "Report an IkaEasy V4 bug",
    "support_email": "Email",
    ...
    "support_agree": "I understand that the error is related to the IkaEasy V4 extension, not to the game",
    ...
    "diplomacy_fast_message_accept": "(Fast)",
    "diplomacy_fast_message_processing": "Processing...",
    "diplomacy_fast_message_error": "Error",
    "diplomacy_fast_message_success": "Success!",
    ...
    "alert.destroy_non_mobile_colony_prompt": "Demolition of non-mobile colony blocked by \"IkaEasy V4\"! If you really want to demolish this town, first turn off the protection option in \"IkaEasy V4\" settings.",
    "option._activated": "activated",
    "option._deactivated": "deactivated",
    "option._accept_hint": "Some settings require a page refresh. The IkaEasy citizen toggle applies immediately.",
    ...
    "option.city_mascot": "Show the IkaEasy character in the city",
    "option.city_mascot_hint": "Uncheck to hide the character. Changes apply immediately, without reloading. When enabled, briefly watches the citizens to learn the roads.",
    "city_mascot.quote_1": "Hypothesis: even Archimedes would run less with IkaEasy!",
    "city_mascot.quote_2": "IkaEasy is not magic — just well-tested science!",
    "city_mascot.quote_3": "IkaEasy saves time. I checked twice, for science!",
    "city_mascot.quote_4": "Eureka! IkaEasy shortened the path to discovery again.",
    "city_mascot.quote_5": "IkaEasy and I found a constant: there is never enough marble!",
    "city_mascot.quote_6": "With IkaEasy, even my shadow follows the scientific method.",
    "city_mascot.quote_7": "IkaEasy checked the calculations. The gods asked for a copy.",
    "city_mascot.quote_8": "The IkaEasy theorem: a full warehouse, but never the resource you need!",
    "city_mascot.quote_9": "IkaEasy reduced entropy. The storekeeper has yet to notice.",
    "city_mascot.quote_10": "With IkaEasy, I calculated infinity: it is the upgrade queue.",
    ...
    "option.empire_resource_drag_drop": "Drag and drop resources between cities in Empire overview",
    "option.empire_military_drag_drop": "Drag and drop forces between cities in Empire overview",
    "option.cinema_floating_player": "Open Cinema videos in a separate mini player",
    "option.check_github_updates": "Check GitHub for new IkaEasy V4 versions",
    "update.available_title": "IkaEasy V4 update available",
    "update.available_text": "Version %VERSION% is available.",
    "update.open_tag": "Open download page",
    "github.repository": "IkaEasy V4 by RandGor on GitHub",
    ...
    "empire.city": "City",
    "empire.resource_drag_hint": "Drag a city onto another city to open the resource transport form.",
    ...
    "empire.espionage_notice": "Last known spy distribution by city. Data refreshes automatically when this tab is opened and can be refreshed manually.",
    "empire.espionage_refresh": "Refresh espionage data for all cities",
    "empire.espionage_level": "Hideout",
    ...
    "empire.military_ships": "Navy",
    "empire.military_notice": "Last known forces by city. Data refreshes automatically when this tab is opened and can be refreshed manually.",
    "empire.military_no_data": "No military data has been collected yet.",
    "empire.military_refresh": "Refresh military data for all cities",
    "empire.military_drag_hint": "Drag a city onto another city in the Army or Navy table to open the deployment form.",
    "empire.unit_phalanx": "Hoplite",
    "empire.unit_steamgiant": "Steam Giant",
    "empire.unit_spearman": "Spearman",
    "empire.unit_swordsman": "Swordsman",
    "empire.unit_slinger": "Slinger",
    "empire.unit_archer": "Archer",
    "empire.unit_marksman": "Sulphur Carabineer",
    "empire.unit_ram": "Battering Ram",
    "empire.unit_catapult": "Catapult",
    "empire.unit_mortar": "Mortar",
    "empire.unit_gyrocopter": "Gyrocopter",
    "empire.unit_bombardier": "Balloon-Bombardier",
    "empire.unit_cook": "Cook",
    "empire.unit_medic": "Doctor",
    "empire.unit_spartan": "Spartan",
    "empire.unit_ship_flamethrower": "Flamethrower",
    "empire.unit_ship_steamboat": "Steam Ram",
    "empire.unit_ship_ram": "Ram Ship",
    "empire.unit_ship_catapult": "Catapult Ship",
    "empire.unit_ship_ballista": "Ballista Ship",
    "empire.unit_ship_mortar": "Mortar Ship",
    "empire.unit_ship_rocketship": "Rocket Ship",
    "empire.unit_ship_submarine": "Submarine",
    "empire.unit_ship_paddlespeedship": "Paddle Speedboat",
    "empire.unit_ship_ballooncarrier": "Balloon Carrier",
    "empire.unit_ship_tender": "Tender",
